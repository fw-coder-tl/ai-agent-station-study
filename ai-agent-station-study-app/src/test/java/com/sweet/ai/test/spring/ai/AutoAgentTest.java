package com.sweet.ai.test.spring.ai;
...
public class AutoAgentTest {
    ...
    public void init() {
        ...
        OpenAiApi openAiApi = OpenAiApi.builder()
                ...
                .apiKey("sk-EPCeIrD8SSQdSFRh92E4F72bD3Cf4c1e8f23E651B3D6D7B5")
        ...
        executorChatClient = ChatClient.builder(chatModel)
                .defaultSystem("""
                        ...
                        **观察：** 记录执行结果，分析是否达到预期目标
                        ...
                        今天是 {current_date}。
                        """)
                .defaultToolCallbacks(new SyncMcpToolCallbackProvider( sseMcpClient()).getToolCallbacks())
                .defaultAdvisors(
                        PromptChatMemoryAdvisor.builder(
                                MessageWindowChatMemory.builder()
                                        .maxMessages(100)
    ...
    public void test_multi_turn_conversation() {
        ...
        log.info("第二轮会话用户输入：{}",secondQuery);
    ...
    public McpSyncClient stdioMcpClient() {
        var stdioParams = ServerParameters.builder("npx")
                .args("-y", "@modelcontextprotocol/server-filesystem", "/Users/liang.tian/Desktop", "C:/develop//ai-agent-station-study")
                .build();
