package com.sweet.ai.types.job.config;

import com.sweet.ai.types.job.TaskJob;
import com.sweet.ai.types.job.provider.ITaskDataProvider;
import com.sweet.ai.types.job.service.ITaskJobService;
import com.sweet.ai.types.job.service.TaskJobService;
