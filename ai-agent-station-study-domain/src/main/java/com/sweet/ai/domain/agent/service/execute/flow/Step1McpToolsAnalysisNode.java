package com.sweet.ai.domain.agent.service.execute.flow;
...
import com.sweet.ai.domain.agent.model.valobj.enums.AiClientTypeEnumVO;
import com.sweet.ai.domain.agent.service.execute.flow.factory.DefaultFlowAgentExecuteStrategyFactory;
...
public class Step1McpToolsAnalysisNode extends AbstractExecuteSupport{
    ...
    protected String doApply(ExecuteCommandEntity requestParameter, DefaultFlowAgentExecuteStrategyFactory.DynamicContext dynamicContext) throws Exception {
        ...
        // 获取MCP客户端工具
        ChatClient mcpToolsChatClient = getChatClientByClientId(requestParameter.getAiAgentId());
